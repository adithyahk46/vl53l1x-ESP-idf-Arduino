// Reffer https://www.l33t.uk/ebay-tutorials/getting-started-with-the-vl53l1x/  for working principle and Circuit diagram
//Download this library from https://github.com/pololu/vl53l1x-arduino ----or--- install it from Arduino library manager
...
#define XSHUT_A 4    // XSHUT pin of sensor_a is connected to pin D4
#define XSHUT_B 25   // XSHUT pin of sensor_a is connected to pin D25
